...
+(NSInteger)timeStamp:(NSString *)time
{
    NSDateFormatter *formate = [[NSDateFormatter alloc] init];
    [formate setDateFormat:@"yyyy-MM-dd HH:mm:ss"];
...
+(CGRect)getFramByString:(NSString *)string andattributes:(NSDictionary *)attributes
{
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0) {
        ...
        else
        {
            ...
            paragraphStyle.lineBreakMode=NSLineBreakByCharWrapping;
            paragraphStyle.lineSpacing=0;
            rect=[string boundingRectWithSize:CGSizeMake(200, 1000) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSParagraphStyleAttributeName:paragraphStyle,NSFontAttributeName:do_FontName(17)} context:nil];
        }
    ...
    else
    {
        ...
        {
            retSize = [string sizeWithFont:do_FontName(17) constrainedToSize:CGSizeMake(200, 1000) lineBreakMode:NSLineBreakByCharWrapping];
...
+(CGRect)getFramByString:(NSString *)string andattributes:(NSDictionary *)attributes andCGSizeWidth:(CGFloat)width
{
    ...
    if ([[[UIDevice currentDevice] systemVersion] floatValue] >= 7.0) {
        ...
        else
        {
            ...
            paragraphStyle.lineBreakMode=NSLineBreakByCharWrapping;
            paragraphStyle.lineSpacing=2;
            rect=[string boundingRectWithSize:CGSizeMake(width, 1000) options:NSStringDrawingUsesLineFragmentOrigin attributes:@{NSParagraphStyleAttributeName:paragraphStyle,NSFontAttributeName:do_FontName(17)} context:nil];
        }
        if(![string isEqualToString:@""])
        {
            return rect;
    ...
    else
    {
        ...
        {
            retSize = [string sizeWithFont:do_FontName(17) constrainedToSize:CGSizeMake(width, 1000) lineBreakMode:NSLineBreakByCharWrapping];
...
+(NSString *)unitConversion:(NSInteger)num
{
    ...
    else if(num>=1000 && num <=9999)
    {
        ...
        totalStr=[NSString stringWithFormat:@"%.1fk",(num/10000.0)];
    }
    else if(num>=10000)
    {
        totalStr=[NSString stringWithFormat:@"%.1f万",(num/100000.0)];
    }
    else
    {
